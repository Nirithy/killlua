...
let match = html.match(/const result = LuaDeob\.deobfuscate\(currentBytecode, -1, false, false, false, false, false, false, false\);/);
if (match) {
    let replaced = match[0].replace(
        "const result = LuaDeob.deobfuscate(currentBytecode, -1, false, false, false, false, false, false, false);",
